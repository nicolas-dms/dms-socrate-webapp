...
const mathTypes = [
  { key: "add", label: "Additions" },
  { key: "sub", label: "Subtractions" },
  { key: "mul", label: "Multiplications" },
  { key: "div", label: "Divisions" },
...
export default function GenerateMathPage() {
  ...
  const handleGenerate = async (e: React.FormEvent) => {
    ...
    // Mock PDF generation
    setTimeout(() => {
      setPdfUrl("/mock-math-session.pdf");
      setGenerating(false);
    }, 1200);
  };
  ...
  return (
    <ProtectedPage>
      <div className="container mt-5" style={{maxWidth: 600}}>
        <h2 className="mb-4">Generate Math Exercises</h2>
